...
<div class="body-content">
  <div class="module">
    <h1 class ="h1">Add Candidate</h1>
    <br>
    <form class="form" action="addcandidate" method="post" enctype="multipart/form-data" autocomplete="off">
      <div class="alert alert-error"></div>
     <label for="firstname">First Name:</label>
        <input type="text" name="firstname" id="name" required><br>
        
        <label for="lastname">Last Name:</label>
        <input type="text" name="lastname" id="surname" required><br>
        <br>
              <label > Year:</label>
       <label >II</label>
        <input type="radio" id ="year" name="year"value="II">
        <label >III</label>
        <input type="radio" id ="year" name="year"value="III">
      <br><br>
      <div class="avatar"><label>Upload Image </label><input type="file" name="image" accept="image/*" required /></div>
