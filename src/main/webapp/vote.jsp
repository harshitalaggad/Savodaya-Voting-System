...
<%@page import="com.Dao.VoterDaoImpl"%>
<%@page import="com.Dao.VoterDao"%>
<%@page import="com.pojo.Voter"%>
<%@page
  ...
  <header class="text-white bg-dar">
    ...
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
        ...
        <a href=voterlogout class="mr-5 hover:text-gray-900">LogOut</a>
      </nav>
   ...
   <%
	...
	String password = (String) session.getAttribute("VoterPassword");
	//out.print(username);
	...
	<table class="table">
		...
		<tr>
			...
			<td><img src="data:image/jsp;base64,<%= utils.displayImage(candidate.getImage())%>" alt=></td>

			<td><a href="vote?candidateSno=<%=candidate.getSNo()%>&voterRollno=<%=Id%>"> Vote</a></td>
		</tr>
		<%
		}
		%>
